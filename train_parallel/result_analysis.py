...
RESULT_SUMMARY_DIR = '/public12_data/fl/shared/share_mala/llm-dro/results/result_summary/'
...
def load_source_target_results(task_name, train_method, source_state, target_state_list, model_name):
    ...
    # find dir 
    path = f'/public12_data/fl/shared/share_mala/llm-dro/results/{task_name}/{train_method}/{source_state_str}/{model_name}'
