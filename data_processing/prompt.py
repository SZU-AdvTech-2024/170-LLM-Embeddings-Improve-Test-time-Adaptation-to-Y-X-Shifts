...
def get_domain_info(task):
    if task.task_name == 'income':
        domain_info = domain_info_dict[task.task_name][task.prompt_method][task.task_name]['domainlabel'][task.state]
        return domain_info
    elif task.task_name == 'mobility':
...
domain_info_dir =  '/public12_data/fl/shared/share_mala/llm-dro/domain_info'
