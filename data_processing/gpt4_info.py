...
task_name = 'income'
prompt_method = 'gpt4'
root_dir = '/public12_data/fl/shared/share_mala/llm-dro/domain_info'
...
def get_gpt4_embedding(task):
    ...
    np.save(f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/gpt4/{task}.npy", embedding)
