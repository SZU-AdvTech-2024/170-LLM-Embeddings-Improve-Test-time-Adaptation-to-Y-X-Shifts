...
class MLP_concat(nn.Module):
    def __init__(self, input_dim, num_classes, num_embeddings=51, embedding_dim=4096, hidden_dim=64, nonlin=nn.ReLU(), dropout_ratio=0.1, 
        ...
        if initial_embedding_method == 'wiki':
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/wiki/{task_name}.npy"
        elif initial_embedding_method == 'arxiv64':
            ...
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/random/{task_name}.npy"
        elif initial_embedding_method == 'gpt4':        # ask gpt4 to generate domain info
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/gpt4/{task_name}.npy"
        elif initial_embedding_method == 'incontext':   # use 35 labeled data as domain info
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/incontext/{task_name}.npy"
        elif initial_embedding_method == 'incontext8':   # use 8 labeled data as domain info
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/incontext8/{task_name}.npy"
        elif initial_embedding_method == 'incontext16':   # use 16 labeled data as domain info
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/incontext16/{task_name}.npy"
        elif initial_embedding_method == 'incontext32':   # use 32 labeled data as domain info
            initial_embedding_path = f"/public12_data/fl/shared/share_mala/llm-dro/domain_info/incontext32/{task_name}.npy"
        else: 
