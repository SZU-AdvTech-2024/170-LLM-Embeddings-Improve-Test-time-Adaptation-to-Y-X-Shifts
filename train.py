...
def load_train_val_test_data(args):
    ...
    data_dir = '/public12_data/fl/shared/share_mala/llm-dro/'
...
def experiment(trainx, trainy, val_dict, test_dict, args):
    ...
    save_dir = '/public12_data/fl/shared/share_mala/llm-dro/'
    if embedding_method == 'one_hot':
        save_model_dir = f'/public12_data/fl/shared/share_mala/llm-dro/save_models/{task_name}/{source_state_str}/{embedding_method}/'
    elif embedding_method == 'e5':
        save_model_dir = f'/public12_data/fl/shared/share_mala/llm-dro/save_models/{task_name}/{source_state_str}/{embedding_method}/{prompt_method}/'
    elif embedding_method == 'concat':
        save_model_dir = f'/public12_data/fl/shared/share_mala/llm-dro/save_models/{task_name}/{source_state_str}/{embedding_method}/{initial_embedding_method}/{training_method}/'
    else:
        raise NotImplementedError
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gpu_id', default=6, type=int, help='gpu id')
